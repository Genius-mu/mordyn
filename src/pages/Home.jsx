...
const Home = () => {
  ...
  return (
    <>
      ...
      <section className="py-[15%] bg-center object-center flex justify-center items-center lg:py-[5%] bg-[url(/images/img6.webp)] bg-[rgba(0,0,0,.5)] bg-blend-darken mt-[5em] bg-center bg-cover">
        <div className="w-[90%] flex justify-between items-center flex-col lg:flex-row gap-y-5">
          <div className="w-full flex flex-col justify-center items-center lg:items-start gap-y-2">
            ...
            <p className="text-white text-[16px] md:text-xl text-center lg:text-left max-w-[500px]">
          ...
          <div className="w-fit flex justify-center items-center h-[23em]">
            <img
              src="/images/img5.webp"
              className="w-[30em] h-full rounded-3xl border-4 border-blue-600 flex justify-center items-center object-center opacity-90 shadow-2xl"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="w-[90%] h-full flex justify-center flex-col gap-y-5">
          <div className="flex justify-between w-full h-fit">
            <span className="flex flex-col gap-y-2">
              <h3 className="text-blue-600 uppercase text-[11px] md:text-xs font-bold tracking-[4px]">
                featured arrivals
              </h3>
              <h2 className="text-black font-bold text-xl md:text-4xl">
                Selected for You
              </h2>
            </span>
            <span>
              <Link
                to="/shop"
                className="text-blue-600 flex uppercase font-medium md:font-bold text-[13px] justify-center items-center"
              >
                <span>
                  Browse All Shop
                </span>
          ...
          <div className="w-full gap-3 h-fit grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-center items-center">
      ...
      <section className="flex justify-center items-center w-full py-[8%]">
        <div className="flex justify-center items-center flex-col gap-y-3">
          <h2 className="text-black font-bold text-3xl md:text-4xl text-center">
            Join the Atelier
          </h2>
          <p className="text-gray-600 max-w-[350px] md:max-w-[600px] text-center">
            g Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut
